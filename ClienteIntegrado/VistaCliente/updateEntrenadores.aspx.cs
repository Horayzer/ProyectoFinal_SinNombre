...
{
    public partial class updateEntrenadores : System.Web.UI.Page
    {
        ...
        protected void btnInsertar_Click(object sender, EventArgs e)
        {
            ...
            string resultado = ActualizarEntrenador(entrenador);
        ...
        private string ActualizarEntrenador(EntrenadorDTO entrenador)
        {
            try
            {
                // Llamar al método del servicio web para insertar el entrenador
                ServicioFutbolSoapClient clienteSOAP = new ServicioFutbolSoapClient();
                string resultado = clienteSOAP.EntrenadoresActualizar(entrenador);
