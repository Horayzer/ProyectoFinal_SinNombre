<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="updateJugadores.aspx.cs" Inherits="VistaCliente.updateJugadores" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container">
            ...
            <div>
                <asp:Button ID="btnInsertar" runat="server" Text="Actualizar Jugador" OnClick="btnInsertar_Click" />
            </div>
            <div>
