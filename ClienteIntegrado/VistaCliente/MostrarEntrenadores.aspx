<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostrarEntrenadores.aspx.cs" Inherits="VistaCliente.MostrarEntrenadores" %>
...
<head runat="server">
    ...
    <style>
    body {
        background-image: url('https://img.freepik.com/vector-gratis/fondo-futbol-degradado-dinamico_23-2149007789.jpg'); /* Reemplaza con la ruta de tu imagen */
    ...
    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal">
        ...
        <div class="form-container">
            ...
            <div class="gridview-container">
                <asp:GridView ID="dgvEntrenadores" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" OnRowEditing="dgvEntrenadores_RowEditing" OnRowDeleting="dgvEntrenadores_RowDeleting">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Foto">
                            <ItemTemplate>
                                <img src='<%# Eval("Foto") %>' alt='<%# Eval("Nombre") %>' style="width: 100px; height: auto; border-radius: 5px;" />
                            </ItemTemplate>
                        </asp:TemplateField>
