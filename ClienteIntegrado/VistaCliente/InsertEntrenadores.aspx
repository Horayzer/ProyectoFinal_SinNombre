<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertEntrenadores.aspx.cs" Inherits="NombreDeTuProyecto.InsertEntrenadores" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Insertar Entrenadores</title>
       <style>
        body {
...
<body>
    ...
    <asp:Menu ID="Menu1" runat="server" Orientation="Horizontal" CssClass="menu-navigation">
        ...
        <div class="form-container">
            ...
            <div>
                <asp:Button ID="btnInsertar" runat="server" Text="Insertar Entrenador" OnClick="btnInsertar_Click" />
            </div>
            <div>
